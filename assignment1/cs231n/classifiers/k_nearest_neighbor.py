...
class KNearestNeighbor(object):
  ...
  def compute_distances_one_loop(self, X):
    ...
    num_train = self.X_train.shape[0]
    dists = np.zeros((num_test, num_train))
    X2X2Tdiag = np.diagonal(np.dot(self.X_train,self.X_train.T))
    for i in xrange(num_test):
      #######################################################################
      # TODO:                                                               #
      ...
      #######################################################################
      X1X1 = np.tile(np.dot(X[i],X[i]),(1,num_train))
      #print X1X1.shape
      X1X2 = np.dot(X[i],self.X_train.T)
      #print X1X2.shape
      #print X2X2Tdiag.shape
      dists[i, :]= np.sqrt(X1X1 - 2*X1X2 + X2X2Tdiag)
      #######################################################################
      #                         END OF YOUR CODE                            #
      #######################################################################
    return dists
